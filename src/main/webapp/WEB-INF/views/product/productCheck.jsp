...
input[type=text] {
    font-family: 'GmarketSansMidium' !important;
    width: 600px;
    outline: 0;
...
<body>
   ...
   <form id="payment" name="payment" action="payment.pt" method="post" onSubmit="return CheckForm(this)">
	       ...
	       <div id="address-info2">
	       		수령인　　<input type="text" name="receiver-name" value="${ loginUser.memName }"><br>
	       		전화번호　<input type="text" name="receiver-phone" value="${ loginUser.memPhone }"><br>
	       		주소　　　<input type="text" name="receiver-postcode" id="postcode" value="${ loginUser.memPostcode }">
	       				<button type="button" id="searchAddr" onclick="getAddress();"><i class="far fa-map"></i>주소검색</button>
	       		　　　　<input type="text" name="receiver-address" id="address" value="${ loginUser.memBasicAddr }"><br>
	       		　　　　　<input type="text" name="receiver-detailAddress" id="detailAddress" value="${ loginUser.memDetailAddr }"><br>
	       		요청사항　<input type="text" name="receiver-request"><br>
