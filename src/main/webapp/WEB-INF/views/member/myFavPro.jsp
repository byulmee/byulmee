				...
				<ul class="sideMenuUl">
					...
					<li>
						...
						<ul class="favDropdown">
							...
							<li>
								<button onclick="location.href='myFavProView.me'" class="sideMenuBtn" id="selectedBtn">찜한 상품</button>
							</li>
							<li>
			...
			<div class="listArea">
				<div class="tab-box">
					<ul>
						...
						<li onclick="location.href='myFavProView.me'" class="selected">찜한 상품</li>
						...
						<div class="list">
							<div class="hoverDiv" onclick="location.href='productDetail.pd?pdId=${ f.product.proNo }'">
								...
								<div class="textDiv">
									...
									<input type="hidden" class="favRefcode" value="2" name="favRefcode">
									<p class="text">${ f.product.proTitle }</p>
									<p class="text"><fmt:formatNumber value="${ f.product.proPrice }"/> 원</p>
