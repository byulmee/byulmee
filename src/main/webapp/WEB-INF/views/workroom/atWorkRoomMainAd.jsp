...
<body>
	...
	<div class="outer">
		...
		<div class="sideMenu">
			...
			<div class="sideMenuList">
				<ul class="sideMenuUl">
					...
					<li class="sideMenuLi">
						<button onclick="" class="sideMenuBtn">상품 목록 관리</button>
					</li>
					<li class="sideMenuLi">
		...
		<div class="MainLogoText">
			<p class="MainText">
				스타 활동 전체보기
				<span class="insertArea"><button class="insertBtn" location.href="'activityInsertForm.wr'">활동등록</button></span>
			</p>
		</div>
		<div class="content">
			...
			<table class="mainTable">
				...
				<tr>
					<td class="imgTd">
						<img class="img" src="../../../images/tennis1.jpg">
						<p class="text">
							[운동] 같이하는 테니스 일일레슨
						</p>
						<p class="priceText"><img class="btnimg" src="../../../images/button1.PNG" align="middle">50,000원</p>
						<p class="priceText2"><img class="btnimg2" src="../../../images/star1.PNG" align="middle">4.8 1891개의 평가</p>
					</td>
					<td class="imgTd">
						<img class="img" src="../../../images/tennis1.jpg">
						<p class="text">
