			...
			<div class="activityArea">
				...
				--%>
					...
					<div class="activity">
						...
						<p class="priceText2"><img class="btnimg2" src="${ pageContext.servletContext.contextPath }/resources/images/board/star1.PNG" align="middle">${ a.actRating } ${ a.actReviewCnt }개의 평가</p>
					</div>
					</c:if>
