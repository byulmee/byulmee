...
<body>
    <nav id="gnb">
        <div id="gnb-menu">
           <div id="gnb-menu-box">
               <img src="resources/images/common/marketlogo.png" id="home-logo" alt="byulmee logo" onclick="location.href='plist.pd?proCategory=0'">
           </div>
               <form id="searchBox">
                   <div>
        ...
        <div id="gnb-cate" class="typeB">
            <ul id="cate">
                ...
                <li class="cate liv" onclick="">리빙</li>
                <li class="cate bea" onclick="">건강/미용</li>
                <li class="cate hel" onclick="">힐링</li>
                <li class="cate fod" onclick="">푸드</li>
                <li class="cate cur" onclick="">커리어</li>
